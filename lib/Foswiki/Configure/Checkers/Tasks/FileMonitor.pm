...
---+ package Foswiki::Configure::Checkers::Tasks::FileMonitor
Configure GUI checker for the {Tasks}{FileMonitor} configuration item.

Validates that the selected Foswiki::Tasks::Watchfile driver is likely to work.
...
sub check {
    ...
    my $driver =  $Foswiki::cfg{Tasks}{FileMonitor} || '';
...
selecting another driver. <br /> The <i><u>Foswiki::Tasks::Watchfile::Polled</u></i> driver should
