...
---+ package Foswiki::Configure::Checkers::Tasks::StatusServerCrlFile
...
sub check {
    ...
    my $crlfile = $Foswiki::cfg{Tasks}{StatusServerCrlFile} || '';
    if( $crlfile ) {
        $Foswiki::cfg{Tasks}{StatusServerCheckCRL} or
    ...
    } elsif( $Foswiki::cfg{Tasks}{StatusServerCheckCRL} ) {
